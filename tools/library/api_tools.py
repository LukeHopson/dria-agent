...
def get_weather(location: str, celsius: Optional[bool] = False) -> str:
    ...
    """
    api_key = os.environ.get("WEATHERSTACK_API_KEY", None) # Replace with your API key from https://weatherstack.com/
    if not api_key:
...
def convert_currency(amount: float, from_currency: str, to_currency: str) -> str:
    ...
    """
    api_key = os.environ.get("EXCHANGERATE_API_KEY", None)  # Replace with your actual API key from https://www.exchangerate-api.com/
